% QTML 2026 extended abstract (non-archival, non-anonymous). One page.
% ACTION: fill in the author name and affiliation before submitting via Indico.
...
{\normalsize [Author name to be completed]$^{1}$}\\[2pt]
{\small $^{1}$[Affiliation to be completed] \quad\textbullet\quad Contact: tanvir.palash@gozayaan.com}\\[2pt]
