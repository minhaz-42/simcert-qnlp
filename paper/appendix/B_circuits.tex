...
give each model's trained state below, and Figure~\ref{fig:circuits_all} shows a representative
circuit for each; the audit truncates that state (Algorithm~\ref{alg:audit}).

\input{figs/fig_circuit.tex}

\input{figs/fig_tn.tex}

\input{figs/fig_circuits_all.tex}
